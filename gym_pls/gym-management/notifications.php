                    ...
                    <table class="table table-hover tbale-bordered" style="border: 2px solid #ff87c3; border-collapse: collapse;">
                        <thead class="thead-dark">
                            <tr style="border: 2px solid #ff87c3;">
                                <th style="border: 2px solid #ff80c3; background-color:#ff87c3;color: #ffffff">Notification id</th>
                                <th style="border: 2px solid #ff80c3; background-color:#ff87c3;color: #ffffff">Member_id</th>
                                <th style="border: 2px solid #ff80c3; background-color:#ff87c3;color: #ffffff">message</th>
                                <th style="border: 2px solid #ff80c3; background-color:#ff87c3;color: #ffffff">Notification_date</th>
