        ...
        <div class="col-md-4">
          <div class="card " style="margin-top: 100px;opacity: 0.7; background-color: #cb77b5;" >
            <div class="card-body " style="font-weight:bold;">
              <center>
              <h4 style="">Register</h4><br>
              <form class="form-group" method="POST" action="func.php">
                <div class="row">
                  <div class="col-md-4"><label>New Username: </label></div>
                ...
                <center><input type="submit" id="inputbtn" name="register_submit" value="Register" class="btn btn-primary" style="background-color: #ff35cb; border: none;">
				<br><br>
    <a href="index.php">
        <button type="button" class="btn btn-light" style="background-color: transparent; border: 0; color:blue; cursor:pointer; ">Go back To Login!</button>
    </a></center>
