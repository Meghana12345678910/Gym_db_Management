...
<html>
<head>
    <title>Members & Traniers Details</title>
                    ...
                    <table class="table table-hover tbale-bordered" style="border: 2px solid #ff87c3; border-collapse: collapse;">
                        <thead class="thead-dark">
                            <tr style="border: 2px solid #ff87c3;">
                                ...
                                <th style="border: 2px solid #ff80c3; background-color:#ff87c3;color: #ffffff">Member Name </th>
                                <th style="border: 2px solid #ff80c3; background-color:#ff87c3;color: #ffffff">Trainer Name</th>
                                <th style="border: 2px solid #ff80c3; background-color:#ff87c3;color: #ffffff">Trainer Contact </th>
                            </tr>   
                        </thead>
                        <tbody>
                            <?php get_member_trainer(); ?>
                        </tbody>
                    </table>
